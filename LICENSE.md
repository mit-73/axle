...
Copyright (c) 2026 ApeironFoundation
...
- All third party components incorporated into the Axle Software are licensed under the original license provided by the owner of the applicable component.
- Content outside of the above mentioned files or restrictions is available under the "Axle Sustainable Use License" as defined below.
...
You may use or modify the software only for personal or non-commercial purposes.
Use by or on behalf of a company, organization, or other commercial entity requires
a separate license from the licensor.
...
or becomes able to license, to make, have made, use, and import the software, in
each case subject to the limitations and conditions in this license. This license
does not cover any patent claims that you cause to be infringed by modifications or
...
The **"licensor"** is ApeironFoundation, the entity offering
these terms.
...
its management and policies by vote, contract, or otherwise. Control can be direct
or indirect.

**"Personal use"** means use by a natural person solely for that person's own private
purposes, not connected to any commercial activity, employment, or engagement with
any organization.

**"Non-commercial purposes"** means purposes that are not intended to generate revenue,
reduce costs for a commercial entity, or gain a competitive advantage.
...
The **"licensor"**, representing itself as ApeironFoundation,
is the original creator and copyright holder of Axle, 
acting in their personal capacity or through any entity they may designate. 
The licensor can be contacted at [mit-73](https://mit-73.github.io/).