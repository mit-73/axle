...
const (
	...
	ProjectServiceName = "bff.v1.ProjectService"
)
...
const (
	...
	// ListProjects RPC.
	ProjectServiceListProjectsProcedure = "/bff.v1.ProjectService/ListProjects"
	// ProjectServiceGetProjectProcedure is the fully-qualified name of the ProjectService's GetProject
	// RPC.
	ProjectServiceGetProjectProcedure = "/bff.v1.ProjectService/GetProject"
	// ProjectServiceCreateProjectProcedure is the fully-qualified name of the ProjectService's
	// CreateProject RPC.
	ProjectServiceCreateProjectProcedure = "/bff.v1.ProjectService/CreateProject"
	// ProjectServiceUpdateProjectProcedure is the fully-qualified name of the ProjectService's
	// UpdateProject RPC.
	ProjectServiceUpdateProjectProcedure = "/bff.v1.ProjectService/UpdateProject"
	// ProjectServiceDeleteProjectProcedure is the fully-qualified name of the ProjectService's
	// DeleteProject RPC.
	ProjectServiceDeleteProjectProcedure = "/bff.v1.ProjectService/DeleteProject"
)

// ProjectServiceClient is a client for the bff.v1.ProjectService service.
...
// NewProjectServiceClient constructs a client for the bff.v1.ProjectService service. By default, it
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_bff_v1_projects_proto.Services().ByName("ProjectService").Methods()
...
// ListProjects calls bff.v1.ProjectService.ListProjects.
...
// GetProject calls bff.v1.ProjectService.GetProject.
...
// CreateProject calls bff.v1.ProjectService.CreateProject.
...
// UpdateProject calls bff.v1.ProjectService.UpdateProject.
...
// DeleteProject calls bff.v1.ProjectService.DeleteProject.
...
// ProjectServiceHandler is an implementation of the bff.v1.ProjectService service.
...
func NewProjectServiceHandler(svc ProjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/bff.v1.ProjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *v1.ListProjectsRequest) (*v1.ListProjectsResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("bff.v1.ProjectService.ListProjects is not implemented"))
}

func (UnimplementedProjectServiceHandler) GetProject(context.Context, *v1.GetProjectRequest) (*v1.GetProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("bff.v1.ProjectService.GetProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) CreateProject(context.Context, *v1.CreateProjectRequest) (*v1.CreateProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("bff.v1.ProjectService.CreateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) UpdateProject(context.Context, *v1.UpdateProjectRequest) (*v1.UpdateProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("bff.v1.ProjectService.UpdateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) DeleteProject(context.Context, *v1.DeleteProjectRequest) (*v1.DeleteProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("bff.v1.ProjectService.DeleteProject is not implemented"))
}
